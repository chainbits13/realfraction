  ...
  return (
    ...
    <div className="properties" id="marketplace">
      <Container>
        ...
        />
        <p className="gray-50 text-center mb-4 mx-auto" style={{ maxWidth: "520px" }}>
          Buy, rent, or bid at auction. Fractional ownership available.
        </p>
        <p className="text-center mb-4">
          <Link to="/marketplace"><Button variant="primary">View Marketplace</Button></Link>
        </p>
        {/* Start tabs */}
