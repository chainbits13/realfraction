  ...
  return (
    <div className="loading position-relative">
      <Container className="d-flex justify-content-between align-items-center gap-md-5 flex-column flex-md-row mt-3 mt-xl-4 overflow-hidden">
        ...
        >
          <AnimationTitles title="Programmable Real Estate" />
          <p className="gray-90 mt-3 fs-5" style={{ maxWidth: "420px" }}>
            Buy, rent, or bid on properties. NFT ownership, fractional investment, and transparent transactions—on-chain.
          </p>
          <Button
            as={Link}
            to={ROUTES.MARKETPLACE}
            className="btn-cta m-0 my-3 px-4 py-2 fs-5"
          >
            Explore Marketplace
          </Button>
          <div
          ...
          <div className="cards">
            ...
            <Card className="bg-black-100">
              <Card.Body className="p-2">
                ...
                <p className="gray-90">@RealFraction US</p>
                <div className="d-flex">
                  <div className="me-3">
